 ...
 */
public class GaaItem extends Item {

    private String mTitle;
    private String mDescription;

    public static GaaItem create(String title, String description) {
        return new GaaItem(title, description);
    }

    GaaItem(String title, String description) {
        mTitle = title;
