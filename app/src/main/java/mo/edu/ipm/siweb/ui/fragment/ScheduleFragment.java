...
//                mViewPager.setScroll(true);
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return mContext.getString(R.string.category_class);
                case 1:
                    return mContext.getString(R.string.category_exam);
                case 2:
                    return mContext.getString(R.string.category_assignment);
                default:
                    return null;
            }
        }
    ...
    private void setUpViewPager() {
        SchedulePagerAdapter schedulePagerAdapter = new SchedulePagerAdapter(getContext(), getChildFragmentManager());
